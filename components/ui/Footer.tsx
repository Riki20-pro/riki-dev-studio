...
export function Footer() {
  ...
  return (
    <footer className="relative mt-20 overflow-hidden border-t border-white/[0.05] bg-black py-12">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-6 flex gap-4">
              {SOCIALS.map((social, idx) => (
                <a
                  ...
                  className="flex size-10 items-center justify-center rounded-full border border-white/10 bg-white/[0.02] text-zinc-400 transition-all hover:border-white/20 hover:bg-white/10 hover:text-white"
        ...
        <div className="mt-16 flex flex-col items-center justify-between border-t border-white/[0.05] pt-8 sm:flex-row">
          ...
          <button
            onClick={scrollToTop}
            className="group mt-4 flex items-center gap-2 text-xs font-medium text-zinc-500 transition-colors hover:text-white sm:mt-0"
          >
            Back to top
